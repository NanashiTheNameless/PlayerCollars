...
import io.github.nanashithenameless.playercollars.block.InvisibleFenceBlock;
import io.github.nanashithenameless.playercollars.item.*;
import io.github.nanashithenameless.playercollars.leash.LeashImpl;
import io.github.nanashithenameless.playercollars.leash.LeashProxyEntity;
import io.github.nanashithenameless.playercollars.network.*;
...
public class PlayerCollarsMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		UseEntityCallback.EVENT.register((PlayerEntity player, World world, Hand hand, Entity entity, @Nullable EntityHitResult hitResult) -> {
			if (world.isClient) return ActionResult.PASS;
			if (player.isSpectator()) return ActionResult.PASS;
			if (entity instanceof LeashKnotEntity ke && blockLeashKnotBreak((ServerWorld) world, player, ke)) {
