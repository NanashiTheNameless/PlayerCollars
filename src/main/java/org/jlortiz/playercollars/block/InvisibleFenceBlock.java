...
public class InvisibleFenceBlock extends HorizontalFacingBlock {
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return state.get(HALF) == DoubleBlockHalf.LOWER ? OUTLINE_SHAPES[state.get(FACING).getHorizontal()] : VoxelShapes.empty();
    }
    ...
    protected void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        ...
        Vec3d pushBack = new Vec3d(state.get(FACING).getUnitVector());
