...
public final class LeashProxyEntity extends TurtleEntity {
    ...
    public LeashProxyEntity(LivingEntity target, @Nullable BlockPos navigateTo, int followRange) {
        ...
        if (shouldNavigate) {
            ...
            getAttributeInstance(EntityAttributes.GENERIC_MOVEMENT_SPEED).setBaseValue(1.75f);
            getAttributeInstance(EntityAttributes.GENERIC_JUMP_STRENGTH).setBaseValue(0.65f);
